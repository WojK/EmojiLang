...
public class EmojiLangParser extends Parser {
	...
	public static final int
		...
		T__17=18, IF=19, FOR=20, READ=21, PRINT=22, OPEN_BRACKET=23, CLOSE_BRACKET=24, 
		DEC_KW=25, END_STAT=26, ID=27, REAL=28, INT=29, ADD=30, SUB=31, MULT=32, 
		DIV=33, WS=34;
	public static final int
		...
		RULE_arrayDeclaration = 12, RULE_arrayValues = 13, RULE_assignValueToStructure = 14, 
		RULE_structProp = 15, RULE_structPropValue = 16, RULE_structName = 17, 
		RULE_fname = 18, RULE_fargs = 19, RULE_fargsType = 20, RULE_ret = 21, 
		RULE_if = 22, RULE_blockif = 23, RULE_equal = 24, RULE_equalFactor = 25, 
		RULE_loop = 26, RULE_repetitions = 27, RULE_loopBlock = 28, RULE_globalDeclatarion = 29, 
		RULE_globalValue = 30, RULE_declaration = 31, RULE_assignment = 32, RULE_expression0 = 33, 
		RULE_expression1 = 34, RULE_expression2 = 35, RULE_arrValue = 36, RULE_valueFromStructProp = 37, 
		RULE_structProperty = 38, RULE_read = 39, RULE_print = 40;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"arrayDeclaration", "arrayValues", "assignValueToStructure", "structProp", 
			"structPropValue", "structName", "fname", "fargs", "fargsType", "ret", 
			"if", "blockif", "equal", "equalFactor", "loop", "repetitions", "loopBlock", 
			"globalDeclatarion", "globalValue", "declaration", "assignment", "expression0", 
			"expression1", "expression2", "arrValue", "valueFromStructProp", "structProperty", 
			"read", "print"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, "IF", "FOR", "READ", "PRINT", 
			"OPEN_BRACKET", "CLOSE_BRACKET", "DEC_KW", "END_STAT", "ID", "REAL", 
			"INT", "ADD", "SUB", "MULT", "DIV", "WS"
		};
	}
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 65858L) != 0)) {
				{
				{
				setState(82);
				globalStat();
	...
	public final FunBlockContext funBlock() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 175637312L) != 0)) {
				{
				{
				setState(127);
				stat();
	...
	public final ArrayValuesContext arrayValues() throws RecognitionException {
		...
		enterRule(_localctx, 26, RULE_arrayValues);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
	...
	public final AssignValueToStructureContext assignValueToStructure() throws RecognitionException {
		...
		enterRule(_localctx, 28, RULE_assignValueToStructure);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(187);
	...
	public final StructPropContext structProp() throws RecognitionException {
		...
		enterRule(_localctx, 30, RULE_structProp);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(193);
	...
	public final StructPropValueContext structPropValue() throws RecognitionException {
		...
		enterRule(_localctx, 32, RULE_structPropValue);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final FargsTypeContext fargsType() throws RecognitionException {
		...
		enterRule(_localctx, 40, RULE_fargsType);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final BlockifContext blockif() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_blockif);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final EqualFactorContext equalFactor() throws RecognitionException {
		...
		enterRule(_localctx, 50, RULE_equalFactor);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final RepetitionsContext repetitions() throws RecognitionException {
		...
		enterRule(_localctx, 54, RULE_repetitions);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final GlobalDeclatarionContext globalDeclatarion() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_globalDeclatarion);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(257);
	...
	public final GlobalValueContext globalValue() throws RecognitionException {
		...
		enterRule(_localctx, 60, RULE_globalValue);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Expression0Context expression0() throws RecognitionException {
		...
		enterRule(_localctx, 66, RULE_expression0);
		try {
			setState(282);
			_errHandler.sync(this);
	...
	public final Expression1Context expression1() throws RecognitionException {
		...
		enterRule(_localctx, 68, RULE_expression1);
		try {
			setState(293);
			_errHandler.sync(this);
	...
	public final ArrValueContext arrValue() throws RecognitionException {
		...
		enterRule(_localctx, 72, RULE_arrValue);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(306);
	...
	public final ValueFromStructPropContext valueFromStructProp() throws RecognitionException {
		...
		enterRule(_localctx, 74, RULE_valueFromStructProp);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(311);
	...
	public final StructPropertyContext structProperty() throws RecognitionException {
		...
		enterRule(_localctx, 76, RULE_structProperty);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(315);
	...
	public final ReadContext read() throws RecognitionException {
		...
		enterRule(_localctx, 78, RULE_read);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(317);
